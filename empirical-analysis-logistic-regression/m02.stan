...
model {
  ...
  aEdMes ~ multi_normal(zeros, diag_matrix(tens));    //array of T-vectors of experience offsets to the mean for each target
  aEmpMat ~ multi_normal(zeros, diag_matrix(tens));   
