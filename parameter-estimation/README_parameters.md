# Bunce-2020-xcultural-competence/parameter-estimation
...
This analysis uses the empirical data to estimate values of parameters in the theoretical model, corresponding to Appendix Figures S13 and S14.
