...
######### Combined plots using results of m4, m5, and m14

#### density plots of ego responses
pdf(file="./Plots/response_dens_IRT.pdf", 
height=7, width=7)
...
pdf(file="./Plots/decomp_pheno_dens_IRT.pdf", 
height=7, width=8)
...
#### density plots of xcult comp
pdf(file="./Plots/decomp_pheno_eduemp_dens_IRT.pdf", 
height=7, width=8)
layout( matrix(c(1,2), 2, 1, byrow = TRUE), respect=TRUE, widths = lcm(16))
par(mar = c(2, 0, 0, 0), oma = c(1, 1, 1, 1)) #margins for indiv plot, oma for outer margins (bottom, left, top, right)
...
pdf(file="./Plots/pheno_dens_non_xcult_IRT.pdf", 
height=7, width=7)
layout( matrix(c(1,2,3,4), 2, 2, byrow = TRUE), respect=TRUE)#widths=c(1.9,1,1) )
par(mar = c(2, 0, 0, 0), oma = c(5, 4, 4, 4)) #margins for indiv plot, oma for outer margins (bottom, left, top, right)
...
pdf(file="./Plots/pheno_dens_non_uni_IRT.pdf", 
height=7, width=7)
layout( matrix(c(1,2,3,4), 2, 2, byrow = TRUE), respect=TRUE)#widths=c(1.9,1,1) )
par(mar = c(2, 0, 0, 0), oma = c(5, 4, 4, 4)) #margins for indiv plot, oma for outer margins (bottom, left, top, right)
...
pdf(file="./Plots/pheno_dens_reduc_IRT.pdf", 
height=7, width=7)
layout( matrix(c(1,2,3,4), 2, 2, byrow = TRUE), respect=TRUE)#widths=c(1.9,1,1) )
